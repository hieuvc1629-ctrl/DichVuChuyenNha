...
public interface DamagesService {
    DamageResponse createDamage(DamageRequest request);
    DamageResponse updateDamage(Integer damageId, DamageRequest request);
    List<DamageResponse> getAllDamages();
    DamageResponse getDamageById(Integer damageId);
    void deleteDamage(Integer damageId);
}
