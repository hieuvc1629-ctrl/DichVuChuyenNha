...
public interface QuotationForCustomerMapper {
    ...
    @Mapping(target = "services", expression = "java(mapQuotationServices(quotationServices.getQuotation().getQuotationServices()))")
    ...
    @Mapping(target = "quotationId", source = "quotationServices.quotation.quotationId")
